...
[System.Windows.Forms.ListBox]$output = $null
...
$output = (New-Object -TypeName System.Windows.Forms.ListBox)
...
$NetwrkBtn.add_Click($NetwrkBtn_Click)
#
#RTclockBtn
#
...
$RTclockBtn.add_Click($RTclockBtn_Click)
#
#PWexpireBtn
#
...
$PWexpireBtn.add_Click($PWexpireBtn_Click)
#
#PWresetBtn
#
...
$PWresetBtn.add_Click($PWresetBtn_Click)
#
#output
#
$output.FormattingEnabled = $true
$output.Location = (New-Object -TypeName System.Drawing.Point -ArgumentList @([System.Int32]116,[System.Int32]6))
$output.Name = [System.String]'output'
$output.Size = (New-Object -TypeName System.Drawing.Size -ArgumentList @([System.Int32]343,[System.Int32]212))
$output.TabIndex = [System.Int32]0
$output.add_SelectedIndexChanged($output_SelectedIndexChanged)
#
#UserUtilities
#
...
Add-Member -InputObject $UserUtilities -Name output -Value $output -MemberType NoteProperty
